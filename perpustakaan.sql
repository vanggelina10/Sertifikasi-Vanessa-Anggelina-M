...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 07, 2024 at 07:45 AM
...
(1, 'To Kill a Mockingbird', 'Harper Lee', 1960, 'Novel ini mengikuti kisah Scout Finch, seorang anak perempuan yang tinggal di sebuah kota kecil di Alabama selama Depresi Besar. Cerita ini membahas ketidaksetaraan rasial dan sistem hukum yang tidak adil melalui pengalaman Scout dan ayahnya, seorang peng', '', ''),
...
INSERT INTO `perpustakaan` (`id`, `judul_buku`, `nama_peminjam`, `tanggal_pinjam`, `tanggal_pengembalian`) VALUES
(9988806, '1984', 'inez', '2024-01-06', '2024-01-13'),
(9988807, '1984', 'koke', '2024-01-06', '2024-01-13'),
(9988808, 'The Kite Runner', 'vAneZ', '2024-01-06', '2024-01-13'),
(9988809, 'Norwegian Wood', 'vanya', '2024-01-06', '2024-01-13'),
(9988810, 'The Great Gatsby', 'titi', '2024-01-07', '2024-01-14'),
(9988811, 'To Kill a Mockingbird', 'yohan', '2024-01-07', '2024-01-14'),
(9988812, '1984', 'ava', '2024-01-07', '2024-01-14');
...
--
ALTER TABLE `katalog_buku`
  MODIFY `id_buku` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=308;
...
--
ALTER TABLE `perpustakaan`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9988813;
